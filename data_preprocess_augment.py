...
for line in train_data:
    ...
    # Create the first augmented version (X2)
    augmented_line_1 = augment_sentence_shuffle(line)
    if augmented_line_1:
        augmented_train_data.append(augmented_line_1)
    
    # Create the second augmented version (X3)
    augmented_line_2 = augment_sentence_shuffle(line)
    if augmented_line_2:
        augmented_train_data.append(augmented_line_2)

    # Create the sthird augmented version (X4)
    augmented_line_3 = augment_sentence_shuffle(line)
    if augmented_line_3:
        augmented_train_data.append(augmented_line_3)

    # Create the fourth augmented version (X5)
    # augmented_line_4 = augment_sentence_shuffle(line)
    # if augmented_line_4:
        # augmented_train_data.append(augmented_line_4)
